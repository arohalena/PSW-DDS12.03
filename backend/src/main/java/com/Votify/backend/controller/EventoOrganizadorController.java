...
public class EventoOrganizadorController extends GenericController<EventoOrganizadorMO>{
    
    private final EventoOrganizadorService eventoOrganizadorService;

    @Override
    protected GenericService<EventoOrganizadorMO> getService(){
    ...
    @PostMapping
    public EventoOrganizadorMO create(@RequestBody EventoOrganizadorMO eventoOrganizador){
