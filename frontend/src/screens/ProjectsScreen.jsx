    ...
    <main style={{ padding: "2rem" }}>
        ...
        <div>
          ...
          <p>
            {desdeEvento
              ...
              : "Administra los proyectos por evento"}
          </p>
        </div>
      ...
      {!desdeEvento && (
        <div style={{ marginBottom: "1.5rem" }}>
          <label style={{ display: "flex", flexDirection: "column", gap: "0.25rem", maxWidth: "400px" }}>
            <span style={{ fontWeight: 500 }}>Selecciona un evento</span>
            <select
      ...
      {!idEfectivo ? (
        <div className="feedback-card">Selecciona un evento para ver sus proyectos.</div>
      ) : (
        <>
